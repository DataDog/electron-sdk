...
| `telemetrySampleRate`              | `number`                                 | No       | `20`     | Percentage of SDK instances that report telemetry (0–100). Drawn once at `init()` and kept for the lifetime of the process.                                                          |
| `telemetryConfigurationSampleRate` | `number`                                 | No       | `20`     | Percentage of telemetry-enabled SDK instances that also report the SDK configuration (0–100). Applied as a child of `telemetrySampleRate`, and drawn once at `init()`.               |
| `telemetryUsageSampleRate`         | `number`                                 | No       | `20`     | Percentage of telemetry-enabled SDK instances that also report SDK API usage (0–100). Applied as a child of `telemetrySampleRate`, and drawn once at `init()`.                       |
