...
| `traceSampleRate`         | `number`                                 | No       | `100`    | Percentage of sampled sessions traced (0–100). `0` omits APM spans and HTTP trace headers but keeps unlinked RUM resources. Applied as a child of `sessionSampleRate`.               |
