 ...
 * Source: rum-events-format/schemas/rum-events-electron-schema.json
 *
...
export type RumEvent =
  RumErrorEvent | RumResourceEvent | RumViewEvent | RumViewUpdateEvent | RumExecutionContextEvent | RumVitalEvent;
/**
