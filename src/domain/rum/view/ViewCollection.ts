import { elapsed, ONE_MINUTE, ONE_SECOND, timeStampNow, toServerDuration } from '@datadog/js-core/time';
import { generateUUID, Subscription, TimeStamp } from '@datadog/browser-core';
import {
  EventFormat,
  EventKind,
  EventManager,
