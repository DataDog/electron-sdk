...
import { init, stopSession, addError, _generateTelemetryError } from '@datadog/electron-sdk';
...
ipcMain.handle('addError', () => {
  addError(new Error('test custom error'), { context: { nonce: 'abc123' } });
});
